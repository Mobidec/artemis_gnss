...
===========================
   ...
   .. autopackagesummary:: artemis_gnss
      :toctree: artemis_gnss
...
pip install build
python -m build
twine check dist/artemis_gnss-0.0.0-py3-none-any.whl
pip install dist/artemis_gnss-0.0.0-py3-none-any.whl
pytest
```

Replace `artemis_gnss` with the name of your repository. Once installed, the package becomes part of your dependencies, and you can use it in your code with `import artemis_gnss` or `from artemis_gnss import module`.
